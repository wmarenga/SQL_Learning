/* Criando o banco pela interface gráfica (pgAdmin 4) */

/*
1) Servers/ PostgreeSQL xx/ Database (botão direito);
2) Em General/ Database: Nome_da_Dadabase
3) <Save>

Atenção para conectar na base de dados correta.

Abrindo o console do SQL:
> Tools/ PSQL Tool
